...
struct SuggestedSection_Previews: PreviewProvider {
  static var previews: some View {
    SuggestedSection(data: [FakeWallupData.shared.unsplashPhoto, FakeWallupData.shared.unsplashPhoto, FakeWallupData.shared.unsplashPhoto])
      .previewLayout(.sizeThatFits)
  }
}
...
struct ColorSection_Previews: PreviewProvider {
  static var previews: some View {
    ColorSection(data: FakeWallupData.shared.colorItemList)
      .previewLayout(.sizeThatFits)
  }
}
...
struct CategoriesSection_Previews: PreviewProvider {
  static var previews: some View {
    CategoriesSection(data: FakeWallupData.shared.categoryList)
      .previewLayout(.sizeThatFits)
  }
}
